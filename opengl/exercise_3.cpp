...
int main() {
  ...
  // setup
  unsigned int VBO1, VBO2, VAO1, VAO2, vertexShader, fragmentShader, yellowShader, shaderProgram, yellowProgram;
  ...
  glShaderSource(yellowShader, 1, &yellow_fragmentShaderSource, NULL);
